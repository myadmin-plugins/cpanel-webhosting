	...
	public static function getMenu(GenericEvent $event)
	{
		...
		if ($GLOBALS['tf']->ima == 'admin') {
			...
			if (has_acl('module_config')) {
				...
				$menu->add_link('whminformation', 'choice=none.whm_version', '/images/whm/version.gif', _('Display cPanel &amp; WHM Version'));
